 ...
 */
$settings['trusted_host_patterns'] = [
  getenv($env.'_TRUSTED_HOST_PATTERNS'),
];
/**
...
$settings['update_free_access'] = (bool) getenv($env.'_UPDATE_FREE_ACCESS');
$settings['reverse_proxy'] = (bool) getenv($env.'_REVERSE_PROXY');
$settings['reverse_proxy_addresses'] = [getenv($env.'_REVERSE_PROXY_ADDRESSES')];
...
$settings['file_public_path'] = 'sites/default/files';
$settings['file_private_path'] = getenv($env.'_FILE_PRIVATE_PATH');
$settings['file_temp_path'] = getenv($env.'_FILE_TEMP_PATH');
$settings['file_scan_ignore_directories'] = [
  'node_modules',
  'bower_components',
];
...
$settings['config_sync_directory']  = getenv($env.'_CONFIG_PATH');

$databases['default']['default'] = array (
    'database' => getenv($env.'_DB_NAME'),
    'username' => getenv($env.'_DB_USER'),
    'password' => getenv($env.'_DB_PASS'),
    'prefix' => '',
    'host' => getenv($env.'_DB_HOST'),
    'port' => '3306',
